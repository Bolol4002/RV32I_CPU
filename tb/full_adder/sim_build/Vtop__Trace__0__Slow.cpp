...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+6,(vlSelfRef.full_adder__DOT__a));
    bufp->fullBit(oldp+7,(vlSelfRef.full_adder__DOT__b));
    bufp->fullBit(oldp+8,(vlSelfRef.full_adder__DOT__cin));
    bufp->fullBit(oldp+9,(vlSelfRef.full_adder__DOT__sum));
    bufp->fullBit(oldp+10,(vlSelfRef.full_adder__DOT__cout));
}
